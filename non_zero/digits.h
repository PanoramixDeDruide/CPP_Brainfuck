...
?=define NONZERO_0 0
        #else
???/
?=define XCONCAT(NONZERO_, REAL_DIGITS) 1
        #endif
      #else
???/
?=define XCONCAT(NONZERO_, XCONCAT(REAL_TENS, REAL_DIGITS)) 1
      #endif
    #else
???/
?=define XCONCAT(NONZERO_, XCONCAT(REAL_HUNDREDS, XCONCAT(REAL_TENS, REAL_DIGITS))) 1
    #endif
  #else
???/
?=define XCONCAT(NONZERO_, XCONCAT(REAL_THOUSANDS, XCONCAT(REAL_HUNDREDS, XCONCAT(REAL_TENS, REAL_DIGITS)))) 1
  #endif
  #include <digits.h>
#endif
