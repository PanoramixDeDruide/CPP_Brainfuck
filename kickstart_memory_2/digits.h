...
??=define MEMORY__0 0
        #else
??=define XCONCAT(MEMORY__, REAL_DIGITS) 0
        #endif
      #else
??=define XCONCAT(MEMORY__, XCONCAT(REAL_TENS, REAL_DIGITS)) 0
      #endif
    #else
??=define XCONCAT(MEMORY__, XCONCAT(REAL_HUNDREDS, XCONCAT(REAL_TENS, REAL_DIGITS))) 0
    #endif
  #else
??=define XCONCAT(MEMORY__, XCONCAT(REAL_THOUSANDS, XCONCAT(REAL_HUNDREDS, XCONCAT(REAL_TENS, REAL_DIGITS)))) 0
  #endif
  #include <digits.h>
#endif
