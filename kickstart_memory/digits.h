...
??=define MEMORY_0 0
        #else
??=define XCONCAT(MEMORY_, REAL_DIGITS) 0
        #endif
      #else
??=define XCONCAT(MEMORY_, XCONCAT(REAL_TENS, REAL_DIGITS)) 0
      #endif
    #else
??=define XCONCAT(MEMORY_, XCONCAT(REAL_HUNDREDS, XCONCAT(REAL_TENS, REAL_DIGITS))) 0
    #endif
  #else
??=define XCONCAT(MEMORY_, XCONCAT(REAL_THOUSANDS, XCONCAT(REAL_HUNDREDS, XCONCAT(REAL_TENS, REAL_DIGITS)))) 0
  #endif
  #include <digits.h>
#endif
