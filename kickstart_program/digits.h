...
#define XCONCAT(a, b) CONCAT(a, b)
    ...
    #define REAL_THOUSANDS 0
      ...
      #if TENS == 0
        #if DIGITS == 0
??=define PROGRAM_0 END
        #else
??=define XCONCAT(PROGRAM_, REAL_DIGITS) END
        #endif
      #else
??=define XCONCAT(PROGRAM_, XCONCAT(REAL_TENS, REAL_DIGITS)) END
      #endif
    #else
??=define XCONCAT(PROGRAM_, XCONCAT(REAL_HUNDREDS, XCONCAT(REAL_TENS, REAL_DIGITS))) END
    #endif
  #else
??=define XCONCAT(PROGRAM_, XCONCAT(REAL_THOUSANDS, XCONCAT(REAL_HUNDREDS, XCONCAT(REAL_TENS, REAL_DIGITS)))) END
  #endif
  #include <digits.h>
#endif
